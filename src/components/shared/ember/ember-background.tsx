...
export function EmberBackground({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ background: "#030710" }}>
      <FilmGrain />

      {/* Mouse-reactive cosmic glow */}
      <div
        className="pointer-events-none fixed inset-0 z-[1]"
        style={{
          background: `radial-gradient(ellipse 55% 50% at ${50 + (mx - 0.5) * 6}% ${47 + (my - 0.5) * 6}%, rgba(84,173,255,${0.06 + proximity * 0.03}) 0%, transparent 100%)`,
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center z-[6]">
          {[0, 1, 2, 3].map(i => (
            <div key={i} className="absolute rounded-full" style={{
              ...
              background: `radial-gradient(circle, rgba(96,220,255,${0.52 - i * 0.08}), transparent)`,
              boxShadow: `0 0 ${12 + i * 4}px rgba(80,168,255,0.3), 0 0 ${30 + i * 8}px rgba(85,95,255,0.14)`,
